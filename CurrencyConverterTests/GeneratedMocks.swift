// MARK: - Mocks generated from file: CurrencyConverter/Interactor/AlamoWrapper.swift at 2018-04-30 06:18:53 +0000
...
// MARK: - Mocks generated from file: CurrencyConverter/Interactor/MainInteractor.swift at 2018-04-30 06:18:53 +0000
...
class MockMainInteractor: MainInteractor, Cuckoo.ClassMock {
	...
	struct __StubbingProxy_MainInteractor: Cuckoo.StubbingProxy {
	    ...
	    func loadCurrecyRateList() -> Cuckoo.ClassStubNoReturnFunction<()> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockMainInteractor.self, method: "loadCurrecyRateList()", parameterMatchers: matchers))
	    }
	    ...
	    func clearCache() -> Cuckoo.ClassStubNoReturnFunction<()> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockMainInteractor.self, method: "clearCache()", parameterMatchers: matchers))
	    }
	    
	    func convertAndDisplay() -> Cuckoo.ClassStubNoReturnFunction<()> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockMainInteractor.self, method: "convertAndDisplay()", parameterMatchers: matchers))
	    }
	...
	struct __VerificationProxy_MainInteractor: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func loadCurrecyRateList() -> Cuckoo.__DoNotUse<Void> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return cuckoo_manager.verify("loadCurrecyRateList()", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
...
// MARK: - Mocks generated from file: CurrencyConverter/Interactor/RealmWrapper.swift at 2018-04-30 06:18:53 +0000
...
// MARK: - Mocks generated from file: CurrencyConverter/Model/Currency.swift at 2018-04-30 06:18:53 +0000
...
// MARK: - Mocks generated from file: CurrencyConverter/Model/Rate.swift at 2018-04-30 06:18:53 +0000
...
// MARK: - Mocks generated from file: CurrencyConverter/Presenter/MainPresenter.swift at 2018-04-30 06:18:53 +0000
...
class MockMainPresenter: MainPresenter, Cuckoo.ClassMock {
    ...
    // ["name": "setCurrenciesList", "returnSignature": "", "fullyQualifiedName": "setCurrenciesList(symbols: [String])", "parameterSignature": "symbols: [String]", "parameterSignatureWithoutNames": "symbols: [String]", "inputTypes": "[String]", "isThrowing": false, "isInit": false, "isOverriding": true, "hasClosureParams": false, "@type": "ClassMethod", "accessibility": "", "parameterNames": "symbols", "call": "symbols: symbols", "parameters": [CuckooGeneratorFramework.MethodParameter(label: Optional("symbols"), name: "symbols", type: "[String]", range: CountableRange(942..<958), nameRange: CountableRange(942..<949))], "returnType": "Void", "isOptional": false, "stubFunction": "Cuckoo.ClassStubNoReturnFunction"]
     override func setCurrenciesList(symbols: [String])  {
        
            return cuckoo_manager.call("setCurrenciesList(symbols: [String])",
                parameters: (symbols),
                superclassCall:
                    
                    super.setCurrenciesList(symbols: symbols)
                    )
    ...
    // ["name": "setInfoText", "returnSignature": "", "fullyQualifiedName": "setInfoText(_: String)", "parameterSignature": "_ info: String", "parameterSignatureWithoutNames": "info: String", "inputTypes": "String", "isThrowing": false, "isInit": false, "isOverriding": true, "hasClosureParams": false, "@type": "ClassMethod", "accessibility": "", "parameterNames": "info", "call": "info", "parameters": [CuckooGeneratorFramework.MethodParameter(label: nil, name: "info", type: "String", range: CountableRange(2289..<2302), nameRange: CountableRange(0..<0))], "returnType": "Void", "isOptional": false, "stubFunction": "Cuckoo.ClassStubNoReturnFunction"]
     override func setInfoText(_ info: String)  {
        
            return cuckoo_manager.call("setInfoText(_: String)",
                parameters: (info),
                superclassCall:
                    
                    super.setInfoText(info)
                    )
	...
	struct __StubbingProxy_MainPresenter: Cuckoo.StubbingProxy {
	    ...
	    func setCurrenciesList<M1: Cuckoo.Matchable>(symbols: M1) -> Cuckoo.ClassStubNoReturnFunction<([String])> where M1.MatchedType == [String] {
	        let matchers: [Cuckoo.ParameterMatcher<([String])>] = [wrap(matchable: symbols) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockMainPresenter.self, method: "setCurrenciesList(symbols: [String])", parameterMatchers: matchers))
	    }
	    ...
	    func setInfoText<M1: Cuckoo.Matchable>(_ info: M1) -> Cuckoo.ClassStubNoReturnFunction<(String)> where M1.MatchedType == String {
	        let matchers: [Cuckoo.ParameterMatcher<(String)>] = [wrap(matchable: info) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockMainPresenter.self, method: "setInfoText(_: String)", parameterMatchers: matchers))
	    }
	...
	struct __VerificationProxy_MainPresenter: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func setCurrenciesList<M1: Cuckoo.Matchable>(symbols: M1) -> Cuckoo.__DoNotUse<Void> where M1.MatchedType == [String] {
	        let matchers: [Cuckoo.ParameterMatcher<([String])>] = [wrap(matchable: symbols) { $0 }]
	        return cuckoo_manager.verify("setCurrenciesList(symbols: [String])", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
	    ...
	    @discardableResult
	    func setInfoText<M1: Cuckoo.Matchable>(_ info: M1) -> Cuckoo.__DoNotUse<Void> where M1.MatchedType == String {
	        let matchers: [Cuckoo.ParameterMatcher<(String)>] = [wrap(matchable: info) { $0 }]
	        return cuckoo_manager.verify("setInfoText(_: String)", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
...
// MARK: - Mocks generated from file: CurrencyConverter/View/MainView.swift at 2018-04-30 06:18:53 +0000
